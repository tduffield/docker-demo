...
vagrant_cluster "/Users/tomduffield/mongotest"
directory "/Users/tomduffield/mongotest/repo"
...
vagrant_box 'opscode-ubuntu-12.04' do
  ...
  provisioner_options 'vagrant_config' => <<EOM
    config.vm.synced_folder "/Users/tomduffield/OpenSource", "/mnt/host_src"
